...
from app_claims.models import Batch, CareProvider, Claim, Payment
...
class BatchTest(TestCase):
    ...
    def test_can_get_all_batches(self):
        # get API response
        response = client.get(reverse("app_claims:create-upload-list"))
        # get data from db
        batches = Batch.objects.all()
        serializer = BatchUploadSerializer(batches, many=True)
